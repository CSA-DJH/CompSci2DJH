        ...
        while (enemyhealth>=0){
            battlelength++;
                ...
                while(true){
                    ...
                    if(input.contains("fast")||input.contains("strong")){
                        break;
                    }
                }
...
Scanner user_input=new Scanner(System.in);
        ...
        while(true){
           ...
           System.out.print("What class would you like to play as? ");
            ...
            while (reader.hasNextLine()){
                ...
                if(num1.toLowerCase().contains(characterpicked.toLowerCase())) {
    ...
    System.out.println("");
        ...
        while(true){
            ...
            String weapon=user_input.next();  
            for(int i=0;i<weaponlist.size();i++){
                if(weaponlist.get(i).returnName().toLowerCase().contains(weapon.toLowerCase())) {
        ...
        while(totalhealth>0){
            ...
            Fighting fighting=new Fighting(StringUtils.capitalize(stringadjectives.get(rand.nextInt(stringadjectives.size()-1))+" "+stringnames.get(rand.nextInt(stringnames.size()-1))).trim(),(level+5)*3,(level+5)*3);
            level++;
            String aninput="";
            if(level%10==0){
