...
6/5/16
finalproject v.2
so far the base game is in place, now with stats, different weapons with different chances of damage and a fighting class
 */
package main;
        ...
        while (enemyhealth>=0){
            battlelength++;
                ...
                if(input.equals("fast")){
                    ...
                    strength=2;
                    playerattack=rand.nextDouble()*strength*playerdamage;
                    System.out.println(enemyname+" attacked for "+enemyattack+" damage !");
                    Thread.sleep(2000);
                    System.out.println("You attacked for "+playerattack+" damage !");
...
Scanner user_input=new Scanner(System.in);
    ...
    System.out.println("You were a farmer until one day the evil Spartals came to your farm to collect taxes. ");
        System.out.println("You grabbed the nearest weapon, and fended off the Spartals because you had enough of their repressive ways!");
